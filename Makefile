...
SOURCES = \
	__init__.py \
	sentinel_wms.py sentinel_wms_dockwidget.py

PLUGINNAME = sentinel_wms

PY_FILES = \
	__init__.py \
	sentinel_wms.py sentinel_wms_dockwidget.py

UI_FILES = sentinel_wms_dockwidget_base.ui
...
QGISDIR=/home/mbojko/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
